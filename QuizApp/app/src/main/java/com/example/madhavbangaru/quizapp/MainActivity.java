package com.example.madhavbangaru.quizapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitQuiz(View view) {
        ...
        if (answerThreeCheckBoxOne.isChecked() && answerThreeCheckBoxThree.isChecked()
                && !answerThreeCheckBoxTwo.isChecked() && !answerThreeCheckBoxFour.isChecked()) {
            score += 1;
        }
        ...
        if(score>=4) {
            Toast.makeText(this, getString(R.string.congrats, score, total), Toast.LENGTH_LONG).show();
            resetAnswers();
        }else{
